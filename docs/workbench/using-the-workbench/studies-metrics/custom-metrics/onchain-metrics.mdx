...
![Wallet Conenct - II](./../../../../../assets/images/active-addresses.png)

## Active Senders

Captures the daily count of unique addresses that have sent the token.
![Wallet Conenct - II](./../../../../../assets/images/active-senders.png)

## Active Receivers

Reflects the daily count of unique addresses that have received the token.
![Wallet Conenct - II](./../../../../../assets/images/active-receivers.png)
